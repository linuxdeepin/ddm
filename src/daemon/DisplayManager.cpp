...
namespace DDM {
    ...
    void DisplayManager::AddSession(const QString &name, const QString &seat, const QString &user, const uint &vtnr) {
    ...
    QString DisplayManager::VTUser(uint vtnr) {
    ...
    void DisplayManager::AcquireVT(uint vtnr) {
        VirtualTerminal::acquireVt(static_cast<int>(vtnr));
    }

    void DisplayManager::SwitchToVT(uint vtnr) {
        VirtualTerminal::switchToVt(vtnr);
    }
    ...
    DisplayManagerSession::DisplayManagerSession(const QString &name, const QString &seat, const QString &user, const uint &vtnr, QObject *parent)
    ...
    const uint &DisplayManagerSession::VTNr() const {
        return m_vtnr;
    }
